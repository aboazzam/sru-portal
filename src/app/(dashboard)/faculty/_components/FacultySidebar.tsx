...
export default function FacultySidebar({ userName }: Props) {
  ...
  const NavContent = () => (
    <nav className="flex flex-col h-full">
      <div className="px-5 py-5 border-b border-amber-950 flex items-center">
        <Image
      ...
      <div className="px-4 py-3 border-b border-amber-950">
      ...
      <div className="px-5 py-4 border-t border-amber-950">
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex flex-col w-56 shrink-0 bg-amber-900 min-h-full">
        <NavContent />
      </aside>

      <aside
        className={`md:hidden fixed top-0 start-0 h-full w-64 bg-amber-900 z-50 transition-transform duration-300 ${
