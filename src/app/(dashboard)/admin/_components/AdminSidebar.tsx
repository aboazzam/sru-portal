...
export default function AdminSidebar({ userName }: Props) {
  ...
  const NavContent = () => (
    <nav className="flex flex-col h-full">
      <div className="px-5 py-5 border-b border-green-950 flex items-center">
        <Image
      ...
      <div className="px-4 py-3 border-b border-green-950">
        <p className="text-green-400 text-[10px] uppercase tracking-wider mb-0.5">لوحة التحكم</p>
        <p className="text-green-100 text-xs font-medium">مدير النظام</p>
      </div>
      ...
      <div className="px-5 py-4 border-t border-green-950">
  ...
  return (
    <>
      ...
      {/* Desktop sidebar */}
      <aside className="hidden md:flex flex-col w-56 shrink-0 bg-green-900 min-h-full">
        <NavContent />
      </aside>
