...
import { updateMembershipStatus, updateCouncilAppStatus } from "../_actions";
...
function StatusButtons({ id, initialStatus, action }: { id: string; initialStatus: string; action: (id: string, s: "PENDING"|"APPROVED"|"REJECTED") => Promise<{success?: true; error?: string}> }) {
...
export function MembershipStatusButtons({ id, initialStatus }: { id: string; initialStatus: string }) {
  return <StatusButtons id={id} initialStatus={initialStatus} action={updateMembershipStatus} />;
}

export function CouncilStatusButtons({ id, initialStatus }: { id: string; initialStatus: string }) {
  return <StatusButtons id={id} initialStatus={initialStatus} action={updateCouncilAppStatus} />;
}
