  ...
  return (
    <div className="space-y-5">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">{t("activitiesPage.title")}</h1>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 text-gray-500 text-xs uppercase">
              <tr>
                ...
                <th className="px-5 py-3 text-start">{t("requests.cols.activity")}</th>
                <th className="px-5 py-3 text-start">{t("requests.cols.activityDate")}</th>
