...
export default function AppStatusButtons({ id, initialStatus }: Props) {
      ...
      {status === "PENDING" && (
        <>
          <button
            ...
            disabled={pending}
            className="px-2.5 py-1 bg-green-600 hover:bg-green-700 text-white rounded text-xs font-medium disabled:opacity-50 transition-colors"
          >
            قبول
          </button>
          <button
            ...
            disabled={pending}
            className="px-2.5 py-1 bg-red-500 hover:bg-red-600 text-white rounded text-xs font-medium disabled:opacity-50 transition-colors"
          >
            رفض
          </button>
        </>
