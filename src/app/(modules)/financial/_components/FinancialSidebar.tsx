...
const navItems = [
  { href: "/financial",          label: "لوحة التحكم",       icon: "🏠" },
  { href: "/financial/tuition",  label: "الرسوم الدراسية",   icon: "🎓" },
  { href: "/financial/payments", label: "سجل المدفوعات",     icon: "💳" },
  { href: "/financial/invoices", label: "الفواتير والإيصالات", icon: "📄" },
  { href: "/financial/requests", label: "الطلبات المالية",   icon: "📝" },
];
...
export default function FinancialSidebar({ userName, userRole }: Props) {
    ...
    <nav className="flex flex-col h-full">
      ...
      <div className="px-5 py-3 border-b border-[#E8EDEF]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-[#4A8FA0]">الخدمات المالية</span>
        </div>
      </div>
