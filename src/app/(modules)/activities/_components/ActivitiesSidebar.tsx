...
const navItems = [
  { href: "/activities",                  label: "لوحة التحكم",      icon: "🏠" },
  { href: "/activities/catalog",          label: "الأنشطة المتاحة",  icon: "🎯" },
  { href: "/activities/my-applications",  label: "طلباتي",           icon: "📋" },
];
...
export default function ActivitiesSidebar({ userName, userRole }: Props) {
    ...
    <nav className="flex flex-col h-full">
      ...
      <div className="px-5 py-3 border-b border-[#E8EDEF]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold" style={{ color: PRIMARY }}>الأنشطة الطلابية</span>
        </div>
      </div>
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                  isActive
                    ...
                    : "text-[#506570] hover:bg-[#EFF6FF] hover:text-[#1E40AF]"
                }`}
