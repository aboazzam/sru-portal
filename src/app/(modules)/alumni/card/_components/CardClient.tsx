  ...
  return (
    <div className="inline-grid gap-0.5" style={{ gridTemplateColumns: "repeat(9, 1fr)" }}>
      {pattern.flat().map((cell, i) => (
        <div key={i} className="w-3 h-3 rounded-[1px]" style={{ background: cell ? "#1A2A30" : "#fff" }} />
      ))}
    </div>
  );
}
...
export default function CardClient({ name }: Props) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex rounded-xl overflow-hidden border border-[#E8EDEF]">
          ...
          {!flipped ? (
            <div
              ...
              style={{ background: "linear-gradient(135deg, #875E9E 0%, #5A3E7E 50%, #6CAEBD 100%)", aspectRatio: "1.586" }}
            >
              <div
              ...
              />
              <div className="absolute -bottom-16 -end-16 w-48 h-48 rounded-full opacity-15" style={{ background: "#fff" }} />
              <div className="absolute -top-10 -start-10 w-36 h-36 rounded-full opacity-10" style={{ background: "#6CAEBD" }} />
              ...
              <div className={`relative z-10 p-6 h-full flex flex-col ${isAr ? "text-right" : "text-left"}`} dir={isAr ? "rtl" : "ltr"}>
                <div className="flex items-start justify-between">
                  ...
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl font-bold text-white" style={{ background: "rgba(255,255,255,0.2)" }}>
                    SRU
                  </div>
                </div>
            ...
            <div
              className="relative rounded-3xl overflow-hidden shadow-2xl select-none"
              style={{ background: "linear-gradient(135deg, #1A2A30 0%, #354850 100%)", aspectRatio: "1.586" }}
            >
              ...
              <div className="relative z-10 p-6 h-full flex flex-col justify-end" dir={isAr ? "rtl" : "ltr"}>
                <div className="flex items-end justify-between gap-4">
                  <div className="bg-white p-2 rounded-xl shadow-md">
                    <FakeQR />
                    <p className="text-[9px] text-[#506570] text-center mt-1 font-mono">{p.id}</p>
                  </div>
                  <div className={`flex-1 ${isAr ? "text-right" : "text-left"}`}>
                    ...
                    <p className="text-white/50 text-[9px] mt-2">alumni.sru.edu.sa/verify</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="px-5 py-4 rounded-2xl flex items-start gap-3" style={{ background: "#E8F6F8", border: "1px solid #C8E6EC" }}>
