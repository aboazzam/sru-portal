...
const navItems = [
  { href: "/hala",                 label: "الرئيسية",       icon: "🏠" },
  { href: "/hala/announcements",   label: "الإعلانات",      icon: "📢" },
  { href: "/hala/notifications",   label: "التنبيهات",      icon: "🔔" },
  { href: "/hala/guide",           label: "دليل الجامعة",   icon: "📖" },
];
...
export default function HalaSidebar({ userName, userRole }: Props) {
            ...
            <li key={item.href}>
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                  isActive
                    ? "bg-[#6CAEBD] text-white shadow-sm"
  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed bottom-6 start-6 z-50 w-12 h-12 rounded-full bg-[#6CAEBD] text-white shadow-xl flex items-center justify-center text-xl"
