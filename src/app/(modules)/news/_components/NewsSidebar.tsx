...
const navItems = [
  { href: "/news",     label: "لوحة الأخبار",  icon: "📰" },
  { href: "/news/all", label: "جميع الأخبار",  icon: "🗞️" },
];
...
export default function NewsSidebar({ userName, userRole }: Props) {
    ...
    <nav className="flex flex-col h-full">
      ...
      <div className="px-5 py-3 border-b border-[#E8EDEF]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold" style={{ color: PRIMARY }}>الأخبار الجامعية</span>
        </div>
      </div>
              ...
              <Link
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 ${
                  isActive
                    ...
                    : "text-[#506570] hover:bg-[#F5F3FF] hover:text-[#5B21B6]"
                }`}
